...
// Exibe os erros 
// Session vinda de CuidadorController form_cuidador_submit()
...
<div class="form-cliente-container">
    <section class="form-cliente">
        ...
        <div class="form-cliente-side">
            ...
            <p>Ja possui uma conta? <a href="/projeto_PI/login">Entre aqui!</a></p>
            <img src="assets/imgs/cadastro.png" alt="Imagem de fundo">
        </div>

        <form action="/projeto_PI/form-cuidador-submit" method="post" enctype="multipart/form-data">
            ...
            <div class="form-cliente-fim form">
                ...
                <div>
                    ...
                    <!-- erro -->
                    <?php if (isset($erros['curriculo_invalido'])): ?>
                        <div class="text-warning">
                            <?= $erros['curriculo_invalido'] ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
